...
class Generator(nn.Module):
    ...
    def __init__(self, batch_size, image_size=64, z_dim=100, conv_dim=64):
        ...
        last = [nn.ConvTranspose2d(curr_dim, 3, 4, 2, 1), nn.Tanh()]
...
class Discriminator(nn.Module):
    ...
    def __init__(self, batch_size=64, image_size=64, conv_dim=64):
        ...
        self.imsize = image_size
        layer1 = [SpectralNorm(nn.Conv2d(3, conv_dim, 4, 2, 1)), nn.LeakyReLU(0.1)]
        curr_dim = conv_dim
        ...
        if self.imsize == 64:
            layer4 = [SpectralNorm(nn.Conv2d(curr_dim, curr_dim * 2, 4, 2, 1))]
